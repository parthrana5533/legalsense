  ...
  return (
    ...
    >
      <div className="text-center mb-10">
        ...
        <h1 className="font-heading text-3xl font-bold text-primary">Create your account</h1>
        <p className="text-base text-text-muted mt-2">Start understanding your legal rights today</p>
      </div>
